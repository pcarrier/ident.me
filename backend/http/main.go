...
func main() {
	...
	router.HandleFunc("/stats", func(w http.ResponseWriter, r *http.Request) {
		...
		stats := map[string]interface{}{
			"reqsPrevHour": reqsPrevHour.Val(),
			"reqsThisHour": reqsThisHour.Val(),
			"reqsPrevDay":  reqsPrevDay.Val(),
			"reqsToday":    reqsToday.Val(),
			"ipsThisHour":  ipsThisHour.Val(),
			"ipsToday":     ipsToday.Val(),
		}
